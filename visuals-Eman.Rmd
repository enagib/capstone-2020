...
ggplot(canc_fees_by_quarter)+
  geom_col(aes(quarter,alaska_avg))+
  geom_line(aes(quarter,allegiant_avg), col = "cornflowerblue") +
  geom_line(aes(quarter,american_avg), col = "coral4") +
  geom_line(aes(quarter,delta_avg), col = "greenyellow") +
  geom_line(aes(quarter,frontier_avg), col = "deeppink4") +
  geom_line(aes(quarter,hawaiian_avg), col = "darkseagreen4") +
  geom_line(aes(quarter,jetblue_avg), col = "brown4") +
  geom_line(aes(quarter,virgin_america_avg), col = "darkorchid4") +
  geom_line(aes(quarter,spirit_avg), col = "orange4") +
  geom_line(aes(quarter,united_avg), col = "olivedrab")+
  geom_line(aes(quarter,sun_country_avg), col = "red")+
  geom_line(aes(quarter,island_air_hawaii_avg), col = "blue")+
    geom_line(aes(quarter,us_airways_avg), col = "pink")
```
